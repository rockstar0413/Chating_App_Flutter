...
class ChatScreenWidget extends StatefulWidget {
  ...
  ChatScreenWidget({Key key, this.parentScaffoldKey, this.routeArgument})
      : super(key: key);
  @override
...
class _ChatScreenWidgetState extends StateMVC<ChatScreenWidget> {
    ...
    setState(() {
      _con.listMessages.insert(
          ...
          PrivateMessageModel(
            ...
            createdAt: int.parse(
                msg['createdAt'] == null ? '0' : msg['createdAt'].toString()),
            roomId: msg['roomId'],
            isDeleted: int.parse(
                msg['isDeleted'] == null ? '0' : msg['isDeleted'].toString()),
          ));
    });
  }
  ...
  _sendMessage({String img = ''}) async {
    if (chatcontroller.text.length > _con.limit_letters) {
      Fluttertoast.showToast(
          msg: "letter".tr() + _con.limit_letters.toString());
    } else {
      ...
      if (chatcontroller.text.trim().length == 0 &&
        ...
        if (privateImagePaths.length > 0) {
          ...
          _con.sendnotif(chatcontroller.text.trim(), "You have a new message",
              _con.partnerInfo['deviceToken']);
          setState(() {
            isMessageSent = false;
            _con.listMessages.insert(
                0,
    ...
    return WillPopScope(
      onWillPop: () {
        Navigator.of(context).pushNamed('/NavBar',
            arguments: RouteArgument(currentTab: 2, heroTag: "0"));
      },
      child: Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              children: [
                headBox(),
                Expanded(
                  child: _con.loading ? progress : mainContent(),
                ),
                chatBox()
              ],
            ),
            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.only(
                      left: config.App(context).appWidth(9),
                      top: config.App(context).appWidth(9)),
                  child: Container(
                    width: 12,
                    height: 12,
                ...
                Row(
                  children: [
                    ...
                    if (_con.partnerInfo != null) ...[
                      ...
                      ] else if (_con.partnerInfo['gender'].toString() ==
                          '1') ...[
                        Image.asset(
                  ...
                  children: [
                    Text(
                        widget.routeArgument.param == null
                            ? ""
                            : widget.routeArgument.param['distance'],
                        textAlign: TextAlign.center,
                        maxLines: 1,
                        style: TextStyle(
                            fontSize: 10,
                    ...
                    Text(
                        widget.routeArgument.param == null
                            ? ""
                            : widget.routeArgument.param['credit'] + "%",
                        textAlign: TextAlign.center,
                        maxLines: 1,
                        style: TextStyle(
                            fontSize: 10,
  ...
  void startLoadMore() async {
    ...
    if (jsonResponse['error'] == false) {
      ...
      _con.listMessages
          .addAll(data.map((e) => PrivateMessageModel.fromMap(e)).toList());
              ...
              child: SmartRefresher(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      if (_con.listMessages[index].senderId ==
                          _con.meInfo['_id']) {
                        return GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              if (_con
                                  .listMessages[index].message.isNotEmpty) ...[
                                Container(
                                  color: Color(0xff9496DE),
                                  padding: EdgeInsets.symmetric(
                                  ...
                                  child: ConstrainedBox(
                                    ...
                                    child: Linkify(
                                      ...
                                      text: _con.listMessages[index].message,
                                      style: TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.w400,
                                          color: Colors.white),
                              ...
                              if ((_con.listMessages[index].imgs as List)
                                      .length >
                                  0)
                                GestureDetector(
                                  onTap: () {
                              ...
                              Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                          _con.listMessages[index].sendTime !=
                                                  null
                                              ? _con
                                                  .listMessages[index].sendTime
                                                  .toString()
                                                  .replaceAll(" ", "")
                                                  .tr()
                                              : DateFormat('hh:mm')
                          ...
                          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      color:
                                          Color(0xffC4C4C4).withOpacity(0.55),
                                      image: DecorationImage(
                                ...
                                Padding(
                                    padding: EdgeInsets.only(
                                        left: config.App(context).appWidth(6),
                                        top: config.App(context).appWidth(6)),
                                    child: Container(
                                      width: 10,
                                      height: 10,
                                      padding: EdgeInsets.symmetric(
                            ...
                            GestureDetector(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  if (_con.listMessages[index].message
                                      .isNotEmpty) ...[
                                    Container(
                    ...
                    onTap: () async {
                      ...
                      setState(() {
                        if (privateImagePaths.length < 1) {
                          privateChatImageRes
                              .map((e) => privateImagePaths.add(e.path))
                              .toList();
                          isMessageSent = true;
  ...
  Future<void> uploadMultiImages() async {
    ...
    dio
        .post(
      Constants.SERVER_URL + 'v1/message/upload_multi_imgs',
      data: formData,
      options: Options(
