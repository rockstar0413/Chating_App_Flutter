                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    if (json.decode(json.encode(_listMessages[i].imgs)).length!=0){
                      for (var item in json.decode(json.encode(_listMessages[i].imgs))) {
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            ...
                                            actions: <Widget>[
                                              GestureDetector(
                                                onTap: () {
                                                  _con.cancelTopMessage(_listMessages[i].messageId);
                                              ...
                                              return  GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  BoxDecoration(
                                                      ...
                                                      image:
                                                      DecorationImage(
                                                        image:Image.network(Constants.SERVER_URL + "v1/roomMessages/img-src/" + normal).image,
                                                        fit: BoxFit
                                                            .fill,
                                                      )),
                                                ),
