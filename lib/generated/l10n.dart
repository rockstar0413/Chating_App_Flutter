...
class S {
  ...
  String get sign_in_description {
    return Intl.message(
      'Logging into the APP as a user means you consent to the',
  ...
  String get enter_chatroom_as {
    return Intl.message(
      'Enter chatroom as visitor for an hour',
      name: 'enter_chatroom_as',
      desc: '',
      args: [],
    );
  }

  String get visitor_as_male {
    return Intl.message(
      'Visitor as male',
      name: 'visitor_as_male',
      desc: '',
      args: [],
    );
  }
  ...
  String get visitor_as_female {
    return Intl.message(
      'Visitor as female',
      name: 'visitor_as_female',
      desc: '',
      args: [],
    );
  }
  ...
  String get register_top {
    return Intl.message(
      'Please allow the APP to obtain the mobile phone location so that you can talk to people nearby.',
      name: 'register_top',
      desc: '',
      args: [],
    );
